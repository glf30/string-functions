...
* Other than `.toUpperCase` and `.toLowerCase`, don't use any string methods. Sure, `.substring` would be nice here, but you'll learn just a ton more if you use actual loops!
